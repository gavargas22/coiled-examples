...
from d2geo.attributes import util
...
class SignalProcess():
    ...
    def histogram_equalization(self, darray, kernel=(3,3,3), preview=None):
        """
        Description
        -----------
        ...
        darray, chunks_init = self.create_array(darray, kernel=kernel, preview=preview)        
